            ...
            <div class="card-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($hearing->is_reschedule)
                                        <span class="badge bg-warning text-dark">{{ __('Rescheduled') }}</span>
                                    @else
                                        <span class="badge bg-success">{{ __('Original') }}</span>
                                    @endif
                                </td>
                                <td>
                                    {{-- Attendance Button --}}
                                    <form method="POST"
                                        ...
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-success mb-1">Take Attendance</button>
                                    </form>
                                    ...
                                    <form method="POST"
                                        ...
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-warning mb-1">Reschedule</button>
                                    </form>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted">{{ __('No hearings found') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
